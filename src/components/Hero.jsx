function Hero() {
  return (
    <section
      id="home"
      className="relative overflow-hidden min-h-screen flex items-center justify-center bg-black pt-20 "
    >
      {/* Purple glow */}
      <div className="absolute top-24 right-1/2 translate-x-1/2 w-[500px] h-[500px] bg-violet-600/20 rounded-full blur-[140px]"></div>
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="max-w-[700px] mx-auto mt-8 text-gray-400 text-base  leading-8 sm:text-lg">
